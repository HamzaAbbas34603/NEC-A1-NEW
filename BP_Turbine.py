...
layers_turbine = [4, 10, 25, 1]  # For turbine data
learning_rate = 0.001
momentum = 0.9
activation = 'sigmoid'
epochs = 50
...
nn_turbine = MyNeuralNetwork(layers_turbine, learning_rate, momentum, activation)
loss_turbine = nn_turbine.fit(X_turbine, y_turbine, epochs)

# Predict on the dataset
y_pred = nn_turbine.predict(X_turbine)

# Calculate evaluation metrics
mse = mean_squared_error(y_turbine, y_pred)
mae = mean_absolute_error(y_turbine, y_pred)
mape = mean_absolute_percentage_error(y_turbine, y_pred)
r2 = r2_score(y_turbine, y_pred)
...
plot_loss(loss_turbine, "Turbine Data Loss")
...
plot_actual_vs_predicted(y_turbine, y_pred)
